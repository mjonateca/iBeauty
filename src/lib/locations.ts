export const COUNTRIES = [
  ...
  { code: "AU", name: "Australia", currency: "AUD", symbol: "A$", cities: ["Sydney","Melbourne","Brisbane","Perth","Adelaide"] },
  ...
  { code: "CA", name: "Canadá", currency: "CAD", symbol: "C$", cities: ["Toronto","Montreal","Vancouver","Calgary","Ottawa","Edmonton"] },
  ...
  { code: "DE", name: "Alemania", currency: "EUR", symbol: "€", cities: ["Berlín","Múnich","Hamburgo","Colonia","Frankfurt","Stuttgart"] },
