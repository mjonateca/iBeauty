  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="padding:32px 16px">
    <tr><td align="center">
      <table width="100%" style="max-width:520px;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.1)">
        <tr><td style="background:#b7791f;padding:28px 32px;text-align:center">
        ...
        <tr><td style="padding:28px 32px">
          ...
          <div style="text-align:center;margin-top:24px">
            <a href="${dashboardUrl}" style="background:#b7791f;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:600;font-size:14px">
              Dejar mi reseña
            </a>
          </div>
        ...
        <tr><td style="padding:16px 32px;border-top:1px solid #f3f4f6;text-align:center">
          <p style="margin:0;color:#9ca3af;font-size:12px">Powered by <a href="${buildAppUrl()}" style="color:#b7791f;text-decoration:none">iBeauty</a></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
    ...
    if (bookings && bookings.length > 0) {
      ...
      for (const booking of bookings) {
        try {
          ...
          const shopName = shopObj?.name || "El salón de belleza";
